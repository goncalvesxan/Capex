...
st.set_page_config(
    page_title="CapexVision V23.4.1",
    page_icon="💠",
    layout="wide",
...
/* V23.4 - correção definitiva dos tooltips/hover */
.js-plotly-plot .hoverlayer .hovertext rect {
    fill: rgba(7,19,33,0.96) !important;
...
if menu == "▦ Visão Geral":
    ...
    st.download_button("Baixar análise consolidada em Excel", export_excel(df), file_name="capexvision_v23_4_analise.xlsx", mime="application/vnd.openxmlformats-officedocument.spreadsheetml.sheet")
